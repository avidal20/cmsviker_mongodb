...
class ProductController extends Controller
{
        ...
        $this->modData = [
            'modTitle' => trans('config.mod_products_name'),
            'modMenu' => [
                'home' => [
    ...
    public function index()
    {
        ...
        return $this->view('admin.product.index',compact('plugins','categories'));
    }
    ...
    public function create()
    {
        ...
        return $this->view('admin.product.create',compact('plugins','categories','sizes'));
    }
