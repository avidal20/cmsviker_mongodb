...
<form id="form-obj" data-parsley-validate="" novalidate="" method="post" action="{{ route('groups.updateUser',['id' => $user->id]) }}">
  {{ csrf_field() }}
  {{ method_field('PUT') }}
                ...
                <div class="checkbox">
                    <label class="">
                        <div class="icheckbox_flat-green" style="position: relative;">
                            <input id="is_group_admin" type="checkbox" name="is_group_admin" class="flat" style="position: absolute; opacity: 0;" @if (!is_null($user->is_group_admin) && $user->is_group_admin == 1) checked @endif>
