...
<form id="form-obj" data-parsley-validate="" novalidate="" method="post" action="{{ route('groups.destroyUser',['id' => $user->id]) }}">
  {{ csrf_field() }}
  {{ method_field('DELETE') }}
    ...
    <div class="form-horizontal form-label-left">
      ...
      <div class="form-group">
         ...
         <div class="col-md-6 col-sm-6 col-xs-12">
             <input id="username" type="text" required="required" class="form-control col-md-7 col-xs-12" maxlength="255" name="username" value="{{ $user->username }}">
         </div>
      </div>
      ...
      <div class="form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="checkbox" >
                    <label class="">
                        @if (!is_null($user->is_group_admin) && $user->is_group_admin == 1) 
                            Si
                        @else 
                            No 
                        @endif
  ...
  <script type="text/javascript">       
      $("#form-obj").submit(function(event) {
          ...
          if ($(this).parsley().isValid()) {
            return confirm("{{trans('modules.mod_users_delete_msj_confirm_edit')}}");
          }
