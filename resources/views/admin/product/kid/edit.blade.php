...
<div id="tableReport">
  ...
  <table id="tableProductIndex" class="table table-striped table-bordered">
    <thead>
      ...
      <div class="checkbox">
        <label class="">
          <div class="icheckbox_flat-green @if(in_array($product->id, $productSelected)) checked @endif" style="position: relative;"><input type="checkbox" class="flat" style="position: absolute; opacity: 0;" value="{{ $product->id }}" name="products[]" @if(in_array($product->id, $productSelected)) checked @endif><ins class="iCheck-helper" style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins></div>
        </label>
      </div>
            </td>
        </tr>
