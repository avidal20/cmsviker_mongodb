...
<form id="form" data-parsley-validate="" novalidate="" method="post" action="{{ route('categories.destroy',['id' => $category->id]) }}">
      {{ csrf_field() }}
      {{ method_field('DELETE') }}
  ...
  <script type="text/javascript">       
      $("#form").submit(function(event) {
          ...
          if ($(this).parsley().isValid()) {
            return confirm("{{trans('modules.mod_categories_store_msj_confirm_delete')}}");
          }
